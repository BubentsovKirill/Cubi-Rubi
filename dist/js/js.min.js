...
var Layout = function(){
   var showCatalogBlock = function(){
    var catalogButton = $('.catalogButton');
   ...
   var openMobileSeachBlock = function () {
       var searchButton = $('.search-button');
       var seachBlock = $('.mobile-search-block');
       var input = $('.mobile-search-block input');
       searchButton.on('click', function(){
           if(searchButton.hasClass('search-icon-passive')){
               searchButton.removeClass('search-icon-passive').addClass('search-icon-active');
               seachBlock.removeClass('hidden').addClass('visible');
               $('.mobile-menu').removeClass('visible').addClass('hidden');
               $('.mobile-menu-button').children('i').removeClass('fa-times').addClass('fa-bars');
               input.focus();
               // document.querySelector('body').addEventListener('click',function(event){
               //     var id = event.target.id;
               //     if(id === 'search-block-mobile' || id === 'search-input-mobile'){
               //         console.log(id)
               //     }
               //     else if(id == ''){
               //         console.log(id + 'string');
               //         searchButton.removeClass('search-icon-active').addClass('search-icon-passive');
               //         seachBlock.removeClass('visible').addClass('hidden');
   ...
   return {
       initOpenMobileSeachBlock: function(){
           openMobileSeachBlock();
       },
